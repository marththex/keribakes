...
**To change the link-preview image** (shown when sharing on iMessage, Messenger, WhatsApp, etc.) → replace `public/images/og/og-preview.jpeg`. The OG meta tags in `src/layouts/Layout.astro` reference this file. Target 200–500 KB, 1200×630 px, JPEG format.
